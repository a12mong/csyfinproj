        ...
        <div className="p-8 sm:p-10 space-y-8">
          ...
          <div className="space-y-6 text-sm leading-relaxed text-gray-650">
            ...
            <section className="space-y-3">
              ...
              <p>
                ท่านมีสิทธิ์ในการยกเลิกการเชื่อมต่อบัญชี LINE ของท่านออกจากระบบ <strong>csyfinproj</strong> ได้ตลอดเวลา โดยการกดปุ่ม <strong>"Disconnect"</strong> ที่หน้าประวัติข้อมูลลูกค้าของท่านบนระบบ หรือติดต่อเจ้าหน้าที่ของบริษัทเพื่อให้ลบข้อมูลการเชื่อมโยงระบบออก
              </p>
            </section>
